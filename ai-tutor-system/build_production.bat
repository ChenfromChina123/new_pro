...
echo [完成] 前端构建成功！构建文件位于 ai-tutor-system/vue-app/dist 目录
...
echo [完成] 后端构建成功！构建文件位于 ai-tutor-system/aispring/target 目录
...
echo.
echo 构建产物:
echo   - 前端: ai-tutor-system/vue-app/dist/ (包含混淆后的代码)
echo   - 后端: ai-tutor-system/aispring/target/*.jar
echo.
echo 部署说明:
echo   1. 将 ai-tutor-system/vue-app/dist/ 的内容部署到Web服务器
echo   2. 运行 java -jar ai-tutor-system/aispring/target/*.jar 启动后端服务
echo ========================================================
echo.
