            ...
            <div class="mt-12">
              ...
              <div class="space-y-3">
                <div class="flex items-start">
                  <UIcon name="i-heroicons-trophy" class="mr-3 mt-1 text-yellow-500" />
                  <div>
                ...
                <div class="flex items-start">
                  <UIcon name="i-heroicons-star" class="mr-3 mt-1 text-blue-500" />
                  <div>
                    <p class="font-medium text-gray-900 dark:text-white">
                ...
                <div class="flex items-start">
                  <UIcon name="i-heroicons-academic-cap" class="mr-3 mt-1 text-green-500" />
                  <div>
                    <p class="font-medium text-gray-900 dark:text-white">
...
useHead({
  ...
  meta: [
    { name: 'description', content: '了解Earthworm背后的开发者林晓枫，Java后端开发工程师，专注于后端开发与AI应用' }
  ]
})
</script>
